...
#define	SLT_OFFSET_Y		(0x0FA0)		// XÇ∆àŸÇ»ÇÈèÍçáíçà”Ç™ïKóvÅB
...
#define 	LOOP_NUM_HX			2620			// 18.014kHz/0.110kHz*16times
#define 	LOOP_FREQ_HX		0x00C817B4		// 110Hz  = Freq * 80000000h / Fs(18k)
...
#define 	LOOP_NUM_HY			2882			// 18.014kHz/0.100kHz*16times
#define 	LOOP_FREQ_HY		0x00B5E728		// 100Hz  = Freq * 80000000h / Fs(18k)
...
#ifdef	SEL_CLOSED_AF
#define	LOOP_NUM_HZ			1516			// 18.014kHz/0.190kHz*16times	DVT
#define	LOOP_FREQ_HZ		0x01599D9A		// 190Hz  = Freq * 80000000h / Fs(18k)
// #define	LOOP_GAIN_HZ		0x02492492		// -35dB
#define	LOOP_GAIN_HZ		0x02BE2BE2		// -33dB
...
//********************************************************************************
// temperature compensation parameters : T0217A
//********************************************************************************
...
#define	TEMP_TAB				0x000013E5
#define	TEMP_TAC				0x7FFFD837
#define	TEMP_TAA				0x000013E5
#define	TEMP_TBB				0x00007505
#define	TEMP_TBC				0x7FFF15F5
#define	TEMP_TBA				0x00007505
#define	TEMP_TEMPOFF			0x1B000000
#define	TEMP_TAG				0x43F80000
#define	TEMP_TBG				0xE3180000
#define	TEMP_SHIFTG				0x3FFFFFFF
#define	TEMP_SHOUTAG1			0x00000000
#define	TEMP_SHOUTBG1			0x00000000
#define	TEMP_TCX				0x08
#define	TEMP_TBX				0x01
#define	TEMP_TAX				0x01
...
#ifdef	__OISFLSH__
const stAdj_Temp_Compensation Emily_TempCompParameter[] = {
{
/****** P1 ACT=01 ******/
/* rcodeX */	TEMP_RCODEX,
/* rcodeY */	TEMP_RCODEY,
...
#else	// __OISFLSH__
extern const stAdj_Temp_Compensation Emily_TempCompParameter[];
#endif	// __OISFLSH__
