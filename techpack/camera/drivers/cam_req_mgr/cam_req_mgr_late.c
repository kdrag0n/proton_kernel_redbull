...
static int __init __cam_req_mgr_late_init(void)
{
	return cam_req_mgr_late_init();
}

static void __exit __cam_req_mgr_late_exit(void) { }

module_init(__cam_req_mgr_late_init);
module_exit(__cam_req_mgr_late_exit);
MODULE_DESCRIPTION("Camera Request Manager Late Initialization");
